        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              ...
              { name: "heading", label: "見出し (Enter で改行可)", type: "string", ui: { component: "textarea" } },
          ...
          },
          {
            ...
            type: "object",
            fields: [
              { name: "brandLines", label: "ブランド表記 (1行ずつ)", type: "string", list: true },
              ...
              { name: "linkLegal", label: "法務ページリンク文言", type: "string" },
